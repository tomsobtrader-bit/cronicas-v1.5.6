...
export class CombatSystem {
    ...
    constructor(game) {
        ...
        // Rastreo de ataques posibles al inicio del turno del jugador
        ...
        // ── Estado visual del turno enemigo ──
        this._enemyActionDisplay = null  // { type: "summon"|"attack", name, target? }
        this._enemyActionQueue   = []    // acciones pendientes a mostrar step a step
    }
    ...
    startTurn() {
        ...
        // Calcular ataques posibles para el bonus de fin de turno
    ...
    endTurn() {
        ...
        // ── Sistema de energía por ataques omitidos ──
        // Usar los ataques posibles calculados AL INICIO del turno
    ...
    // ─── Turno del enemigo animado paso a paso ────────────────────────────────

    _enemyTurnAnimated() {
        if (this.gameOver) return

        // Construir cola de acciones del enemigo
    ...
    _getEnemyMaxHp() {
        // Calcular HP máximo del enemigo según nivel para la barra
        const level = this.game?.runManager?.level || 1
        if (level === 1) return 5
                    ...
                    ${troop ? `
                        <div class="troop-overlay">
                            ...
                            <div class="troop-tags">
                                ...
                                ${troop.isMarked                   ? '<span class="tag tag-mark" title="Marcado">🎯</span>'            : ""}
